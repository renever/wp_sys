...
#生产环境的DB_ENGINE
DB_ENGINE = create_engine("mysql://root:123qwe@localhost/wangpan2?charset=utf8&unix_socket=/run/mysqld/mysqld.sock", pool_size=300, max_overflow=1000,echo=True)
