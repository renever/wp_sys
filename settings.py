...
#生产环境的DB_ENGINE
DB_ENGINE = create_engine("mysql://root:123qwe@localhost/wp_sys?charset=utf8&unix_socket=/tmp/mysql.sock", pool_size=300, max_overflow=1000,echo=True)
FirefoxProfilePath =''
# print BASE_PATH
...
# 各种线程池大小
GRAB_ARTICLES_POOL_SIZE = 5

GRAB_ARTICLE_URL_POOL_SIZE = 2

SAVE_ARTICLE_URL_POOL_SIZE = 2
